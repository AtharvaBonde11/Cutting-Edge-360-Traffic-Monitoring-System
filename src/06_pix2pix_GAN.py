...
# Set this to the path of your dataset
path_to_dataset = pathlib.Path("./Panorama")
PATH = path_to_dataset

# Optionally, you can list files to verify the path
list(PATH.iterdir())

# Paths to the train and test directories
train_path = PATH / 'train'
test_path = PATH / 'test'  # or 'val' if your test images are in a 'val' directory
